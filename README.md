...
Motor, line sensor, ultrasonic and LED blocks automatically disable the micro:bit LED matrix due to shared pin usage (P3, P4, P6, P7, P9, P10).
### ~
...
> **Note:** Motor, line sensor, ultrasonic and LED blocks disable the micro:bit LED matrix because P3, P4, P6, P7, P9, P10 are shared with the LED display. Use an I2C OLED display if you need a screen alongside these blocks.
